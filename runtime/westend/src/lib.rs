...
//use pallet_child_bounties::ChildBounties;

use frame_support::{
	construct_runtime, parameter_types,
	traits::{ConstU32, InstanceFilter, KeyOwnerProofSystem, WithdrawReasons,LockIdentifier,EitherOfDiverse},
...
use sp_runtime::{
	...
	ApplyExtrinsicResult, FixedU128, KeyTypeId, Perbill,Permill,Percent,
};
...
construct_runtime! {
		...
		UncheckedExtrinsic = UncheckedExtrinsic
	{
		...
		// Governance stuff.
		Democracy: pallet_democracy::{Pallet, Call, Storage, Config<T>, Event<T>} = 71,
		Council: pallet_collective::<Instance1>::{Pallet, Call, Storage, Origin<T>, Event<T>, Config<T>} = 72,
		TechnicalCommittee: pallet_collective::<Instance2>::{Pallet, Call, Storage, Origin<T>, Event<T>, Config<T>} = 73,
		PhragmenElection: pallet_elections_phragmen::{Pallet, Call, Storage, Event<T>, Config<T>} = 74,
		TechnicalMembership: pallet_membership::<Instance1>::{Pallet, Call, Storage, Event<T>, Config<T>} = 75,
		Treasury: pallet_treasury::{Pallet, Call, Storage, Config, Event<T>} = 76,
		// Bounties modules.
		Bounties: pallet_bounties::{Pallet, Call, Storage, Event<T>} = 77,
		ChildBounties: pallet_child_bounties = 78,

		// Tips module.
		Tips: pallet_tips::{Pallet, Call, Storage, Event<T>} = 79,
